...
const { POST_FOUND, POST_NOT_FOUND, POST_UPDATED, POST_DELETED, POST_CREATED } = require("../lang/en/postConstants");
const PostsModel = require("../models/Posts")
//const PostsModel = require("../models/Posts");

exports.list = async (req,res)=>{
    try {
        const postsData = await PostsModel.paginate({},paginateOptions(req.query));
...
exports.create = async (req, res) => {
	try {
		...
		//const postsData = await new PostsModel(req.body).save();
